...
from lms.djangoapps.course_home_api.urls import urlpatterns as course_home_api_urls
...
urlpatterns += [
    url(r'^course/{}/api'.format(settings.COURSE_KEY_PATTERN), include('lms.djangoapps.course_home_api.urls')),
]
